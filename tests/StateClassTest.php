...
use JeffersonGoncalves\LivewireWizard\Tests\TestSupport\Components\WizardWithCustomStateObject;
use JeffersonGoncalves\LivewireWizard\Tests\TestSupport\Components\WizardWithInitialState;
use JeffersonGoncalves\LivewireWizard\Tests\TestSupport\Components\WizardWithInvalidCustomStateObject;
...
it('can load state from different steps', function () {
    ...
    Livewire::test(SecondStepComponent::class, $wizard->getStepState())
        ->tap(function (Testable $testableLivewire) {
