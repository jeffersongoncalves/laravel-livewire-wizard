...
use JeffersonGoncalves\LivewireWizard\Exceptions\NoNextStep;
use JeffersonGoncalves\LivewireWizard\Exceptions\NoPreviousStep;
use JeffersonGoncalves\LivewireWizard\Exceptions\StepDoesNotExist;
use JeffersonGoncalves\LivewireWizard\Tests\TestSupport\Components\MyWizardComponent;
...
use JeffersonGoncalves\LivewireWizard\Tests\TestSupport\Components\WizardWithInvalidStepComponent;
...
it('can remember state for forms', function () {
    ...
    Livewire::test(FourthStepComponent::class)
        ->update([], [
            'form.name' => 'John Doe',
            'form.email' => 'john@doe.nl',
            'form.likes_coffee' => LikesCoffeeEnum::No->value,
        ])
        ->call('previousStep')
        ->assertDispatched('previousStep')
        ->emitEvents()->in($wizard);
